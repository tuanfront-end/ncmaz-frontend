...
`,X=!!window.frontendObject.pll_current_language&&!!window.frontendObject.pll_themeoption_actived;X&&(Y=`
  query MyQueryPostsOnArchivePageNoFilter(
...
}`,te=({className:r="",lists:e,onChangeSelect:t})=>{const[a,s]=o.exports.useState(e[0]);return o.exports.useEffect(()=>{t&&t(a)},[a]),n("div",{className:`nc-ArchiveFilterListBox ${r}`,"data-nc-id":"ArchiveFilterListBox",children:n($,{value:a,onChange:s,children:I("div",{className:"relative md:min-w-[200px]",children:[n($.Button,{as:"div",children:n(H,{children:a.name})}),n(P,{as:o.exports.Fragment,leave:"transition ease-in duration-100",leaveFrom:"opacity-100",leaveTo:"opacity-0",children:n($.Options,{className:"absolute right-0 z-20 w-52 py-1 mt-1 overflow-auto text-sm text-neutral-900 dark:text-neutral-200 bg-white rounded-md shadow-lg max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-neutral-900 dark:ring-neutral-700",children:e.map((d,f)=>n($.Option,{className:({active:i})=>`${i?"text-primary-700 dark:text-neutral-200 bg-primary-50 dark:bg-neutral-700":""} cursor-default select-none relative py-2 pl-10 pr-4`,value:d,children:({selected:i})=>I(p,{children:[n("span",{className:`${i?"font-medium":"font-normal"} block truncate`,children:d.name}),i?n("span",{className:"text-primary-700 absolute inset-y-0 left-0 flex items-center pl-3 dark:text-neutral-200",children:n(B,{className:"w-5 h-5","aria-hidden":"true"})}):null]})},f))})})]})})})};let c=[];const ae=({enable:r,orderBy:e,heading:t,subHeading:a,itemPerPage:s,parentId:d,isCategory:f})=>{if(!r)return null;let i=T`
    ${D}
  `,l="NAME",m=null;e==="count"&&(l="COUNT"),e==="term_order"&&(l="TERM_ORDER"),e==="is_child"&&(i=T`
      ${w}
    `,f&&d?(l=null,m=d):l="COUNT");const{data:h,error:C,loading:z}=v(i,{notifyOnNetworkStatusChange:!0,variables:m===null?{first:Number(s)||5,orderby:l}:{first:Number(s)||5,orderby:l,parent:m}});c=(h==null?void 0:h.categories.edges)||[];const E=z&&!c.length;return n(p,{children:I("div",{className:"relative py-16",children:[n(R,{}),n(k,{categories:c,heading:t,subHeading:a,isLoadingSkeleton:E}),n("div",{className:"relative mx-auto flex justify-center",children:n(G,{data:c,error:C,isSkeleton:E})})]})})};export{te as A,H as B,D as G,V as P,ae as S,re as U,K as a,w as b,Y as c};
