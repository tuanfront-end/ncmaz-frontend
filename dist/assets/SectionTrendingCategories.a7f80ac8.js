...
`);const re=`query GET_USERS_QUERY_FILTER(
  ...
  `,l="NAME",m=null;e==="count"&&(l="COUNT"),e==="term_order"&&(l="TERM_ORDER"),e==="is_child"&&(i=T`
      ${w}
    `,f&&d?(l=null,m=d):l="COUNT");const{data:E,error:C,loading:z}=v(i,{notifyOnNetworkStatusChange:!0,variables:m===null?{first:Number(s)||5,orderby:l}:{first:Number(s)||5,orderby:l,parent:m}});c=(E==null?void 0:E.categories.edges)||[];const h=z&&!c.length;return n(p,{children:I("div",{className:"relative py-16",children:[n(R,{}),n(k,{categories:c,heading:t,subHeading:a,isLoadingSkeleton:h}),n("div",{className:"relative mx-auto flex justify-center",children:n(G,{data:c,error:C,isSkeleton:h})})]})})};export{te as A,H as B,D as G,K as P,ae as S,re as U,V as a,w as b,Y as c};
