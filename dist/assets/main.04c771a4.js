...
const Te = ({
    ...
    d.createElement(
      ...
      !r &&
        d.createElement(
          "button",
          {
            className: `${l} bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-6000 dark:hover:border-neutral-500 rounded-full flex items-center justify-center hover:border-neutral-300 disabled:opacity-60 disabled:cursor-not-allowed ${je()}`,
            onClick: a,
            title: "Prev",
            "data-glide-dir": "<",
            disabled: o,
  ...
  De = ({ containerClassName: e = "", className: t = "", children: a }) =>
    d.createElement(
      "nav",
...
try {
  if (
    ...
    e && "object" == typeof e && (Be = c(c({}, Be), e));
  }
} catch (fl) {
  console.log("----translate frontend file error ----", fl);
}
var Oe = Be;
const Ve = ({
    tabActiveId: e,
        ...
        l &&
          d.createElement(
            ...
            d.createElement(
              ...
              d.createElement("span", null, " ", Oe.viewAll),
              d.createElement("i", {
  ...
  We = frontendObject.socialsShare.map((e) => ({ id: e, name: e, icon: "" })),
  Ye = ({ className: e = "grid gap-[6px]", href: t = "#", size: a = 24 }) =>
    d.createElement(
      "div",
            ...
            switch (e.id) {
              ...
              case "Odnoklassniki":
                return d.createElement(
                  U,
                  { className: l, url: t },
                  d.createElement(D, { round: !0, size: a })
                );
              case "Reddit":
                return d.createElement(
                  $,
              ...
              case "Tumblr":
                return d.createElement(
                  j,
                  { className: l, url: t },
                  d.createElement(T, { round: !0, size: a })
                );
              case "MailRu":
                return d.createElement(
                  z,
  ...
  Qe = ({ className: e = "flex px-3 h-8 text-xs", href: t, commentCount: a }) =>
    d.createElement(
      ...
      {
        href: t + "#comments",
        className: `nc-PostCardCommentBtn relative items-center min-w-[68px] rounded-full text-neutral-6000 bg-neutral-50 transition-colors dark:text-neutral-200 dark:bg-neutral-800 hover:bg-teal-50 dark:hover:bg-teal-100 hover:text-teal-600 dark:hover:text-teal-500 ${e} ${je()}`,
        title: "Comments",
...
const qe = ({
    ...
    return d.createElement("div", {
      ...
      dangerouslySetInnerHTML: { __html: Ze[l] || e },
    });
  },
  Je = ({
    className: e = "",
  ...
  tt = `\n  query GQL_QUERY_GET_POSTS_BY_SPECIFIC(\n    $nameIn: [String] = ""\n    $author_ncUserMeta_featuredImage_size: MediaItemSizeEnum = THUMBNAIL\n    $featuredImage_size: MediaItemSizeEnum = ${
    ...
    window.innerWidth < 500 ? "MEDIUM" : "MEDIUM_LARGE"
  }\n    ) {\n    posts(where: { nameIn: $nameIn }) { ${Ke} }\n  }\n`,
  at =
    "edges {\n\tnode {\n\t\tid\n\t\tname\n\t\tusername\n\t\tuserId\n\t\turl\n\t\turi\n\t\tncUserMeta {\n\t\t\tcolor\n\t\t\tncBio\n\t\t\tfeaturedImage {\n\t\t\t\tsourceUrl(size: $author_ncUserMeta_featuredImage_size)\n\t\t\t\tid\n\t\t\t}\n\t\t\tbackgroundImage {\n\t\t\t\tsourceUrl(size: $author_ncUserMeta_backgroundImage_size)\n\t\t\t}\n\t\t}\n    posts {\n      pageInfo {\n        total\n      }\n    }\n\t}\n}",
  lt = `query GQL_QUERY_GET_USERS_BY_FILTER(\n\t$after: String = ""\n\t$before: String = ""\n\t$first: Int = 10\n\t$last: Int = null\n\t$field: UsersConnectionOrderbyEnum = DISPLAY_NAME\n\t$order: OrderEnum = ASC\n\t$roleIn: [UserRoleEnum] = []\n  $author_ncUserMeta_featuredImage_size: MediaItemSizeEnum = THUMBNAIL\n  $author_ncUserMeta_backgroundImage_size: MediaItemSizeEnum = ${
    window.innerWidth < 500 ? "MEDIUM" : "MEDIUM_LARGE"
  }\n) {\n\tusers(\n\t\twhere: { orderby: { field: $field, order: $order }, roleIn: $roleIn }\n\t\tlast: $last\n\t\tfirst: $first\n\t\tbefore: $before\n\t\tafter: $after\n\t) { ${at} }\n}`,
  rt = `query GQL_QUERY_GET_USERS_BY_SPECIFIC(\n  $include: [Int] = null\n  $author_ncUserMeta_featuredImage_size: MediaItemSizeEnum = THUMBNAIL\n  $author_ncUserMeta_backgroundImage_size: MediaItemSizeEnum = ${
    window.innerWidth < 500 ? "MEDIUM" : "MEDIUM_LARGE"
  }\n  ) {\n\tusers(where: { include: $include }) { ${at} }\n}`,
  nt =
  ...
  ot = `\n\tquery GQL_QUERY_GET_CATEGORIES_BY_SPECIFIC(\n    $termTaxonomId: [ID] = ""\n    $ncTaxonomyMeta_featuredImage_size: MediaItemSizeEnum = ${
    window.innerWidth < 500 ? "MEDIUM" : "MEDIUM_LARGE"
  }\n    ) {\n\t\tcategories(where: { termTaxonomId: $termTaxonomId }) { ${nt} }\n\t}\n`,
  ct = `\n\tquery GQL_QUERY_GET_TAGS_BY_FILTER(\n\t\t$order: OrderEnum = ASC\n\t\t$orderby: TermObjectsConnectionOrderbyEnum = COUNT\n\t\t$after: String = null\n\t\t$before: String = null\n\t\t$first: Int = 10\n\t\t$last: Int = null\n    $ncTaxonomyMeta_featuredImage_size: MediaItemSizeEnum = ${
    window.innerWidth < 500 ? "MEDIUM" : "MEDIUM_LARGE"
  }\n\t) {\n\t\ttags(\n\t\t\twhere: { order: $order, orderby: $orderby }\n\t\t\tfirst: $first\n\t\t\tbefore: $before\n\t\t\tafter: $after\n\t\t\tlast: $last\n\t\t) { ${nt} }\n\t}\n`,
  it = `\n\tquery GQL_QUERY_GET_TAGS_BY_SPECIFIC(\n    $termTaxonomId: [ID] = ""\n    $ncTaxonomyMeta_featuredImage_size: MediaItemSizeEnum = ${
    window.innerWidth < 500 ? "MEDIUM" : "MEDIUM_LARGE"
  }\n    ) {\n\t\ttags(where: { termTaxonomId: $termTaxonomId }) { ${nt} }\n\t}\n`,
  mt = ({
      ...
      "div",
      {
        ...
        style: {
          backgroundColor: n
            ? void 0
            : ((e) => {
                const t = Math.floor(e.charCodeAt(0) % Xe.length);
                return Xe[t];
              })(s),
        },
      },
...
const ut = ({
    ...
    return d.createElement(
      ...
      d.createElement(
        ...
        d.createElement(
          ...
          d.createElement("span", null, dt(l || "")),
          a &&
            d.createElement(
              d.Fragment,
              null,
  ...
  pt = ({ className: e = "relative", name: t, color: a = "blue", href: l }) => {
    const r = (e = !0) => {
        switch (a) {
          case "pink":
            return (
  ...
  ft = ({ className: e = "", itemClass: t = "", categories: a }) =>
    d.createElement(
      "div",
      {
  ...
  gt = ({
    className:
      e = `h-8 w-8 bg-neutral-100 dark:bg-neutral-800 rounded-full flex items-center justify-center ${je()}`,
  ...
  ht = frontendObject.socialsShare.map((e) => ({ id: e, name: e, icon: "" })),
  vt = ({
            ...
            switch (e.id) {
              ...
              case "Odnoklassniki":
                return d.createElement(
                  U,
                  { className: l, url: t },
                  d.createElement(D, { round: !0, size: 24 }),
                  d.createElement("span", null, e.name)
                );
              case "Reddit":
                return d.createElement(
              ...
              case "Tumblr":
                return d.createElement(
                  j,
                  { className: l, url: t },
                  d.createElement(T, { round: !0, size: 24 }),
                  d.createElement("span", null, e.name)
                );
              case "MailRu":
                return d.createElement(
  ...
  xt = ({ className: e = "h-full", size: t = "normal", post: a }) => {
    var l;
    const {
      featuredImage: r,
      title: n,
    ...
    return d.createElement(
      ...
      d.createElement(
        ...
        d.createElement(
          "div",
          { className: "space-y-3" },
          d.createElement(ft, { categories: c }),
          d.createElement(
            "h2",
            {
              className:
            ...
            d.createElement(
              "a",
              { href: s, className: "line-clamp-2", title: n },
              n
            )
          ),
          i
        ...
        d.createElement(
          ...
          d.createElement(Je, { className: "relative", postData: a }),
          d.createElement(vt, { href: a.link })
        )
      )
    );
  },
  bt = ({ className: e = "h-full", size: t = "normal" }) =>
    d.createElement(
      "div",
      {
    ...
    return d.createElement(
      ...
      d.createElement(
        ...
        d.createElement(
          ...
          {
            className:
              "block text-neutral-700 hover:text-black dark:text-neutral-300 dark:hover:text-white font-medium py-1 truncate",
          },
    ...
    return d.createElement(
      ...
      d.createElement(
        ...
        d.createElement(
          ...
          d.createElement(ft, { categories: s }),
          d.createElement(
            "h2",
          ...
          d.createElement(Nt, { meta: c({}, t) })
        ),
        d.createElement(
          "div",
          { className: "flex items-center flex-wrap justify-between mt-auto" },
          d.createElement(Je, { className: "relative", postData: t }),
          d.createElement(
            "div",
            {
              className:
            ...
            d.createElement(vt, { href: t.link })
          )
        )
      ),
      d.createElement(
    ...
    return d.createElement(
      ...
      d.createElement(
        ...
        d.createElement(
          ...
          t
            ? [1, 1, 1].map((e, t) => d.createElement(wt, { key: t }))
            : e
                .filter((e, t) => t > 0 && t < 4)
                .map((e, t) => d.createElement(kt, { key: t, post: e.node }))
        )
      )
    );
  };
...
const At = ({ galleryImgs: e }) => {
    const t = Ct("gallerySlider_");
    return (
      u.exports.useEffect(() => {
        t && new re("." + t, { gap: 0, perView: 1 }).mount();
      }, []),
      d.createElement(
        "div",
        ...
        d.createElement(
          ...
          d.createElement(Te, { onlyPrev: !0, btnClassName: "w-8 h-8" }),
          d.createElement(Te, { onlyNext: !0, btnClassName: "w-8 h-8" })
        ),
        d.createElement("div", {
          className:
  ...
  St = ({ videoUrl: e, isHover: t }) => {
    let a = null;
    const [l, r] = u.exports.useState(!0),
        ...
        d.createElement(
          "div",
          {
            className:
              ...
              (n ? "pl-[6px] pr-2" : "w-6 hover:scale-125"),
            onClick: () => r(!l),
          },
          l
            ? d.createElement(
  ...
  {
    changeCurrentMediaRunning: _t,
    changeStateMediaRunning: jt,
    removeMediaRunning: Tt,
  } = zt.actions,
  $t = (e) => e.mediaRunning;
var Pt = zt.reducer,
  Ut =
              ...
              ? o.postData.id !== t.id
                ? t.ncmazAudioUrl.audioUrl ===
                  ...
                  (a = null == (e = o.postData) ? void 0 : e.ncmazAudioUrl)
                    ? void 0
                    : a.audioUrl)
                  ? c(_t({ postData: t, state: "playing" }))
                  : c(_t({ postData: t, state: "loading" }))
                : "playing" === o.state
                ? c(jt("paused"))
                : "loading" !== o.state
                ? c(jt("playing"))
...
const Ot = ({ className: e = "w-full h-full", post: t, isHover: a = !1 }) => {
    var l, r;
    const {
        featuredImage: n,
        postFormats: s,
    ...
    return d.createElement(
      ...
      "post-format-gallery" === p
            ...
            return e.length
              ? d.createElement(
                  ...
                  d.createElement(
                    "a",
                    { href: m },
                    d.createElement(At, { galleryImgs: e })
                  )
                )
              : d.createElement(Ge, {
                  containerClassName: "absolute inset-0",
        ...
        : "post-format-video" === p && o.videoUrl && a
        ? d.createElement(St, { isHover: !0, videoUrl: o.videoUrl })
        : "post-format-audio" === p && c.audioUrl
        ? d.createElement(Rt, { post: t })
        : d.createElement(
            "div",
            { className: "absolute inset-0" },
            !!(null == s ? void 0 : s.edges[0]) &&
              ("post-format-video" === p || "post-format-audio" === p) &&
              d.createElement(
                "span",
                {
                  className:
    ...
    return d.createElement(
      ...
      d.createElement(
        ...
        d.createElement(
          "div",
          null,
          d.createElement(Ot, { post: t, isHover: i })
        )
      ),
      d.createElement(
        "span",
        { className: "absolute top-3 inset-x-3 z-10" },
        d.createElement(ft, { categories: o })
      ),
      d.createElement("a", { href: s, className: "absolute inset-0" }),
      d.createElement(
        "div",
  ...
  Ht = ({ className: e = "h-full", ratio: t = "aspect-w-4 aspect-h-3" }) => (
    ...
    d.createElement(
      ...
      d.createElement(
        ...
        d.createElement(
          "div",
          null,
          d.createElement(Ge, { containerClassName: "w-full h-full", src: "." })
        )
      ),
      d.createElement(
        "span",
  ...
  Ft = ({ listPosts: e = [], isLoading: t }) =>
    d.createElement(
      ...
      d.createElement(
        ...
        t
          ? [1, 1].map((e, t) =>
              d.createElement(Ht, { ratio: "aspect-w-5 aspect-h-3", key: t })
            )
          : e
              .filter((e, t) => t < 3 && t > 0)
              .map((e, t) =>
      ...
      d.createElement(
        ...
        t
          ? d.createElement(bt, null)
          : e[0]
          ? d.createElement(xt, { size: "large", post: e[0].node })
          : null
      ),
      d.createElement(
        "div",
    ...
    return d.createElement(
      ...
      d.createElement(
        ...
        d.createElement(
          "div",
          { className: "mb-3" },
          d.createElement(ft, { categories: i })
        ),
        d.createElement(
          "div",
  ...
  Yt = ({ listPosts: e, isLoading: t }) =>
    d.createElement(
      ...
      d.createElement(
        ...
        t
          ? [1, 1, 1, 1].map((e, t) =>
              d.createElement(Wt, { ratio: "aspect-w-3 aspect-h-3", key: t })
            )
          : e
              .filter((e, t) => t < 5 && t >= 1)
              .map((e, t) =>
  ...
  qt = ({ listPosts: e, isLoading: t }) =>
    d.createElement(
      ...
      t
        ? d.createElement(Zt, { className: "sm:col-span-2" })
        : e[0]
        ? d.createElement(Qt, { className: "sm:col-span-2", post: e[0].node })
        : null,
      t
        ? [1, 1].map((e, t) => d.createElement(Wt, { key: t }))
        : e
            .filter((e, t) => t < 3 && t >= 1)
            .map((e, t) => d.createElement(Gt, { key: t, post: e.node })),
      t
        ? [1, 1].map((e, t) => d.createElement(Wt, { key: t }))
        : e
            .filter((e, t) => t < 5 && t >= 3)
      ...
      t
        ? d.createElement(Zt, { className: "sm:col-span-2" })
        : e[5]
        ? d.createElement(Qt, { className: "sm:col-span-2", post: e[5].node })
        : null
    ),
  Jt = ({ className: e = "h-full", post: t }) => {
    var a;
    const {
      title: l,
      link: r,
    ...
    return d.createElement(
      ...
      d.createElement(
        ...
        d.createElement(Nt, { className: "mt-5", meta: t })
      )
    );
  },
  Xt = ({ className: e = "h-full" }) =>
    d.createElement(
      "div",
      {
  ...
  ta = ({ listPosts: e, isLoading: t }) =>
    d.createElement(
      ...
      t
        ...
        : e[0]
        ? d.createElement(Jt, { post: e[0].node })
        : null,
      d.createElement(
        "div",
        { className: "grid grid-cols-1 gap-5 md:gap-7" },
        t
          ? [1, 2, 3].map((e, t) => d.createElement(ea, { key: t }))
          : e
              .filter((e, t) => t < 4 && t > 0)
              .map((e, t) => d.createElement(Kt, { key: t, post: e.node }))
      )
    ...
    return d.createElement(
      ...
      d.createElement(
        ...
        d.createElement(
          "div",
          null,
          d.createElement(Ot, { post: t, isHover: s })
        ),
        d.createElement("span", {
          className:
            "absolute inset-0 bg-neutral-900 bg-opacity-20 opacity-0 group-hover:opacity-100 transition-opacity",
      ...
      d.createElement(
        ...
        d.createElement(ft, { categories: l }),
        d.createElement(qe, {
          postId: n,
      ...
      d.createElement(
        ...
        d.createElement(la, { className: "leading-none w-full", meta: t })
      )
    );
  },
  ...
  sa = ({ className: e = "h-full", post: t, galleryType: a = 1 }) => {
    var l;
    const {
        title: r,
        link: n,
      ...
      d.createElement(
        ...
        d.createElement(
          ...
          "post-format-gallery" !==
            ...
            ? d.createElement(Ot, { post: t, isHover: E })
            : 1 === a
            ? f
              ? d.createElement(
                  "div",
  ...
  oa = ({ className: e = "h-full", galleryType: t = 1 }) =>
    d.createElement(
      "div",
      {
  ...
  ca = ({ listPosts: e, isLoading: t }) =>
    d.createElement(
      ...
      d.createElement(
        ...
        t
          ? d.createElement(oa, null)
          : e[0]
          ? d.createElement(sa, { post: e[0].node })
          : null,
        t
          ? d.createElement(oa, null)
          : e[1]
          ? d.createElement(sa, { galleryType: 2, post: e[1].node })
          : null
      ),
      d.createElement(
        "div",
        {
          className:
            "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8 mt-3",
        },
        t
          ? [1, 1, 1, 1].map((e, t) => d.createElement(na, { key: t }))
          : e
              .filter((e, t) => t > 1)
              .map((e) => d.createElement(ra, { key: e.node.id, post: e.node }))
      )
    );
var ia =
...
const ma = ({
      ...
      d.createElement(
        ...
        d.createElement(
          ...
          d.createElement(
            "div",
            { className: "flex-grow " },
            d.createElement("img", { src: ia, alt: "musicWave" })
          ),
  ...
  fa = ({ listPosts: e, isLoading: t }) =>
    d.createElement(
      "div",
      { className: "grid grid-cols-1 sm:grid-cols-6 gap-6 md:gap-8" },
      t
        ? d.createElement(da, { className: "sm:col-span-3 lg:col-span-2" })
        : e[0]
        ? d.createElement(ma, {
      ...
      d.createElement(
        ...
        t
          ? [1, 1, 1, 1].map((e, t) => d.createElement(pa, { key: t }))
          : e
              .filter((e, t) => t > 1 && t < 6)
              .map((e) => d.createElement(ua, { key: e.node.id, post: e.node }))
      )
    ),
  ...
  ha = ({ listPosts: e, isLoading: t }) =>
    d.createElement(
      ...
      d.createElement(
        ...
        t
          ? d.createElement(Wt, { ratio: "aspect-w-4 aspect-h-3" })
          : e[0]
          ? d.createElement(Gt, {
      ...
      d.createElement(
        ...
        {
          className:
            "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mt-8",
        },
        t
          ? [1, 1, 1, 1, 1, 1].map((e, t) => d.createElement(ga, { key: t }))
          : e
              .filter((e, t) => t > 2)
              .map((e) => d.createElement(Ea, { key: e.node.id, post: e.node }))
      )
    ),
  va = ({
    className: e = "",
      ...
      d.createElement(
        ...
        d.createElement(
          ...
          d.createElement(
            ...
            d.createElement(ft, { categories: p }),
            d.createElement(
              "h2",
      ...
      ? d.createElement(
          ...
          d.createElement(
            ...
            d.createElement(
              "div",
              { className: "p-4 sm:pt-8 sm:px-10" },
              d.createElement(Te, { btnClassName: "w-11 h-11 text-xl" })
            )
          ),
          d.createElement(
            "div",
  ...
  ka = ({ data: e = [], isSkeleton: t, error: a, className: l = "" }) =>
    a || (!t && !e.length)
      ? d.createElement(
          "div",
          { className: l },
          ...
          !t && !e.length && d.createElement(Na, null)
        )
      : null;
function wa(e, t, a = { freezeOnceVisible: !0, rootMargin: "1000px" }) {
  u.exports.useEffect(() => {
    t <= 5 && e();
  }, []);
...
const ya = ({
    ...
    const { graphQLvariables: r, settings: n } = a,
      [s, o] = u.exports.useState(-1),
      [m, p] = u.exports.useState(r.variables || {});
    u.exports.useEffect(() => {
      p(r.variables);
    }, [r]);
    let f = "";
    "GQL_QUERY_GET_POSTS_BY_FILTER" === r.queryString && (f = et),
      "GQL_QUERY_GET_POSTS_BY_SPECIFIC" === r.queryString && (f = tt);
    const E = ie`
    ${f}
  `;
    u.exports.useEffect(() => {
    ...
    const [g, { loading: h, error: v, data: x }] = me(E, {
          ...
          d.createElement(
            ...
            (() => {
              switch (a.settings.sectionName) {
                ...
                case "magazine-2":
                  return d.createElement(Ft, { isLoading: k, listPosts: N });
                case "magazine-3":
                  return d.createElement(Yt, { isLoading: k, listPosts: N });
                case "magazine-4":
                  return d.createElement(qt, { isLoading: k, listPosts: N });
                case "magazine-5":
                  return d.createElement(ta, { isLoading: k, listPosts: N });
                case "magazine-6":
                  return d.createElement(aa, { isLoading: k, listPosts: N });
                case "magazine-7":
                  return d.createElement(ca, { isLoading: k, listPosts: N });
                case "magazine-8":
                  return d.createElement(fa, { isLoading: k, listPosts: N });
                case "magazine-9":
                  return d.createElement(ha, { isLoading: k, listPosts: N });
                case "large-slider":
                  return d.createElement(ba, { isLoading: k, listPosts: N });
                default:
                  return d.createElement(yt, { isLoading: k, listPosts: N });
              }
            })()
  ...
  Ca = d.lazy(() =>
    _e(
      () => import("./FactoryBlockPostsGrid.6a29ccd8.js"),
      [
        "assets/FactoryBlockPostsGrid.6a29ccd8.js",
        "assets/vendor.cb5650ef.js",
        "assets/Card14Skeleton.3595f1ff.js",
        "assets/ButtonPrimary.5184b560.js",
      ]
    )
  ),
  Aa = d.lazy(() =>
    _e(
      () => import("./FactoryBlockPostsSlider.e279e94e.js"),
      [
        "assets/FactoryBlockPostsSlider.e279e94e.js",
        "assets/vendor.cb5650ef.js",
        "assets/Card14Skeleton.3595f1ff.js",
      ]
    )
  ...
  Ia = d.lazy(() =>
    _e(
      () => import("./FactoryBlockTermsSlider.76c4e228.js"),
      [
        "assets/FactoryBlockTermsSlider.76c4e228.js",
        "assets/vendor.cb5650ef.js",
        "assets/CardCategory5Skeleton.39988ce3.js",
      ]
    )
  ),
  Sa = d.lazy(() =>
    _e(
      () => import("./FactoryBlockTermsGrid.edde6a99.js"),
      [
        "assets/FactoryBlockTermsGrid.edde6a99.js",
        "assets/vendor.cb5650ef.js",
        "assets/SectionGridCategoryBox.74cedc2f.js",
        "assets/CardCategory5Skeleton.39988ce3.js",
      ]
    )
  ),
  La = d.lazy(() =>
    _e(
      () => import("./FactoryBlockUsersSlider.9ede050a.js"),
      [
        "assets/FactoryBlockUsersSlider.9ede050a.js",
        "assets/vendor.cb5650ef.js",
        "assets/CardAuthorBox2Skeleton.0aa96f75.js",
        "assets/CardAuthorBoxSkeleton.e88ad85b.js",
      ]
    )
  ),
  Ma = d.lazy(() =>
    _e(
      () => import("./FactoryBlockUsersGrid.538c164c.js"),
      [
        "assets/FactoryBlockUsersGrid.538c164c.js",
        "assets/vendor.cb5650ef.js",
        "assets/CardAuthorBoxSkeleton.e88ad85b.js",
        "assets/CardAuthorBox2Skeleton.0aa96f75.js",
      ]
  ...
  za = d.lazy(() =>
    _e(
      () => import("./FactoryBlockVideos.286eeb18.js"),
      [
        "assets/FactoryBlockVideos.286eeb18.js",
        "assets/vendor.cb5650ef.js",
        "assets/NcPlayIcon.090ef16b.js",
      ]
    )
  ),
  _a = d.lazy(() =>
    _e(
      () => import("./FactoryBlockWidgetPosts.f596c5b8.js"),
      [
        "assets/FactoryBlockWidgetPosts.f596c5b8.js",
        "assets/vendor.cb5650ef.js",
        "assets/WidgetHeading1.41250d60.js",
      ]
    )
  ),
  ja = d.lazy(() =>
    _e(
      () => import("./FactoryBlockWidgetUsers.152594f4.js"),
      [
        "assets/FactoryBlockWidgetUsers.152594f4.js",
        "assets/vendor.cb5650ef.js",
        "assets/WidgetHeading1.41250d60.js",
      ]
    )
  ...
  Ta = d.lazy(() =>
    _e(
      () => import("./FactoryBlockWidgetTerms.bec3dbf8.js"),
      [
        "assets/FactoryBlockWidgetTerms.bec3dbf8.js",
        "assets/vendor.cb5650ef.js",
        "assets/Tag.314b3d11.js",
        "assets/WidgetHeading1.41250d60.js",
      ]
    )
  ),
  $a = document.querySelectorAll("[data-nc-gutenberg-section=true]"),
  Pa = () => {
    let e = 0;
    return d.createElement(
      d.Fragment,
      null,
      Array.from($a).map((t, a) => {
        ...
        return "block-magazine" === n
          ...
          ? d.createElement(
              u.exports.Suspense,
              { key: a, fallback: d.createElement("div", null) },
              d.createElement(za, { key: a, domNode: t, apiSettings: r })
            )
...
const Ua = () => {
  ...
  `,
      [v, { loading: x, error: b, data: N, fetchMore: k }] = me(h, {
        notifyOnNetworkStatusChange: !0,
        variables: E,
      }),
      { ref: w } = wa(v, 99),
              ...
              ? d.createElement(
                  ...
                  A
                    ? Array.from(f ? "88888888" : "8888888888").map((e, t) =>
                        d.createElement(Ra, { key: t })
                      )
                    : C.map((e) =>
                        d.createElement(Da, { post: e.node, key: e.node.id })
                      )
                )
              : null,
            (() => {
  ...
  Oa = document.querySelectorAll("[data-is-megamenu=true]"),
  Va = () =>
    d.createElement(
      d.Fragment,
      null,
      d.createElement(Ua, null),
      d.createElement(
        d.Fragment,
        null,
        Array.from(Oa).map((e, t) => {
...
const Fa = ({ data: e, footData: t }) => {
  ...
  Wa = () => {
    ...
    return d.createElement(
      d.Fragment,
      null,
      d.createElement(ue, { className: "sm:relative" }, ({ open: t }) => {
        var a;
        return (
          t &&
            setTimeout(() => {
  ...
  Ya = ({ className: e = "w-12 h-12" }) => {
    ...
    return d.createElement(
      ...
      t
        ...
        : d.createElement(fe, { className: "w-7 h-7", "aria-hidden": "true" })
    );
  },
  Qa = d.lazy(() =>
    _e(
      () => import("./HeaderSingleAudio.aea5a521.js"),
      ["assets/HeaderSingleAudio.aea5a521.js", "assets/vendor.cb5650ef.js"]
    )
  ),
  Za = d.lazy(() =>
    _e(
      () => import("./HeaderSingleGallery.67d724dc.js"),
      [
        "assets/HeaderSingleGallery.67d724dc.js",
        "assets/vendor.cb5650ef.js",
        "assets/ButtonClose.4d1a0f1c.js",
      ]
    )
  ),
  qa = d.lazy(() =>
    _e(
      () => import("./HeaderSingleVideo.8f377433.js"),
      [
        "assets/HeaderSingleVideo.8f377433.js",
        "assets/vendor.cb5650ef.js",
        "assets/NcPlayIcon.090ef16b.js",
      ]
    )
  ...
  Ja = d.lazy(() =>
    _e(
      () => import("./PageArchiveDate.a4b021ee.js"),
      [
        "assets/PageArchiveDate.a4b021ee.js",
        "assets/vendor.cb5650ef.js",
        "assets/PageArchive.05d18fb0.js",
        "assets/ButtonClose.4d1a0f1c.js",
        "assets/ButtonPrimary.5184b560.js",
        "assets/Tag.314b3d11.js",
        "assets/SectionGridCategoryBox.74cedc2f.js",
  ...
  Xa = d.lazy(() =>
    _e(
      () => import("./PageSearch.a51ab382.js"),
      [
        "assets/PageSearch.a51ab382.js",
        "assets/vendor.cb5650ef.js",
        "assets/PageArchive.05d18fb0.js",
        "assets/ButtonClose.4d1a0f1c.js",
        "assets/ButtonPrimary.5184b560.js",
  ...
  Ka = d.lazy(() =>
    _e(
      () => import("./SingleMoreFromAuthorGridPosts.ea5c1c9e.js"),
      [
        "assets/SingleMoreFromAuthorGridPosts.ea5c1c9e.js",
        "assets/vendor.cb5650ef.js",
        "assets/DataStatementBlock.009a6972.js",
      ]
    )
  ),
  el = d.lazy(() =>
    _e(
      () => import("./SingleRelatedGridPosts.fe418e59.js"),
      [
        "assets/SingleRelatedGridPosts.fe418e59.js",
        "assets/vendor.cb5650ef.js",
        "assets/DataStatementBlock.009a6972.js",
      ]
    )
  ...
  tl = d.lazy(() =>
    _e(
      () => import("./PageArchiveAuthor.642a0d7a.js"),
      [
        "assets/PageArchiveAuthor.642a0d7a.js",
        "assets/vendor.cb5650ef.js",
        "assets/ButtonPrimary.5184b560.js",
        "assets/PageArchive.05d18fb0.js",
        "assets/ButtonClose.4d1a0f1c.js",
  ...
  al = d.lazy(() =>
    _e(
      () =>
        import("./PageArchive.05d18fb0.js").then(function (e) {
          return e.d;
        }),
      [
        "assets/PageArchive.05d18fb0.js",
  ...
  ll = document.querySelectorAll("[data-is-react-component] "),
  rl = ({}) => {
    if (!ll || !ll.length) return null;
    return d.createElement(
      d.Fragment,
      null,
      Array.from(ll).map((e, t) => {
        ...
        switch (("object" != typeof l && (l = []), a)) {
          case "PostCardDropdownShare":
            return de.createPortal(d.createElement(vt, c({}, l)), e);
          case "SocialsShare":
            return de.createPortal(d.createElement(Ye, c({}, l)), e);
          ...
          case "SwitchDarkMode":
            return de.createPortal(d.createElement(Ya, c({}, l)), e);
          case "SearchDropdown":
            return de.createPortal(d.createElement(Wa, c({}, l)), e);
          case "NavAccountDropdown":
            return de.createPortal(d.createElement(Fa, c({}, l)), e);
          default:
            return null;
        }
      })
  ...
  nl = d.lazy(() =>
    _e(
      () => import("./MediaRunningContainer.9b781623.js"),
      ["assets/MediaRunningContainer.9b781623.js", "assets/vendor.cb5650ef.js"]
    )
  );
function sl() {
  return d.createElement(
...
const ml = ge(
    { key: "root", version: 1, storage: xe, whitelist: ["darkmode"] },
    Ee({
      bookmark: ol,
      postLike: cl,
      darkmode: ce({
  ...
  ul = he({
    ...
    middleware: (e) =>
      e({
        serializableCheck: { ignoredActions: [be, Ne, ke, we, ye, Ce] },
      }).concat(dl),
  });
let pl = ve(ul);
if (
  ...
  const e = new Ae({ typePolicies: { Query: { fields: {} } } }),
    t = new Ie({ uri: window.frontendObject.graphQLBasePath, cache: e });
  de.render(
    d.createElement(
      d.StrictMode,
      null,
      d.createElement(
        ...
        d.createElement(
          Le,
          { loading: null, persistor: pl },
          d.createElement(Me, { client: t }, d.createElement(sl, null))
        )
      )
    ),
