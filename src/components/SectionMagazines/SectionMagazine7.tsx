...
const SectionMagazine7: FC<SectionMagazine7Props> = ({
  ...
  return (
    <div className="SectionMagazine7 grid grid-cols-1 gap-x-2 gap-y-5 sm:gap-6 2xl:gap-8">
      <div className="grid gap-x-2 gap-y-5 sm:gap-6 2xl:gap-8 grid-cols-1 lg:grid-cols-2">
        {isLoading ? (
          <Card10V3Skeleton />
        ) : listPosts[0] ? (
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-2 gap-y-5 sm:gap-6 2xl:gap-8 mt-3">
        {isLoading
