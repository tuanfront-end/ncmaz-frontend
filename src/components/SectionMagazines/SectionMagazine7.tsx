...
const SectionMagazine7: FC<SectionMagazine7Props> = ({
  ...
  return (
    <div className={`SectionMagazine7 grid grid-cols-1 gap-6 2xl:gap-8`}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 2xl:gap-8 mt-3">
        {isLoading
