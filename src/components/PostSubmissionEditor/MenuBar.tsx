...
export default ({ editor }: { editor: Editor }) => {
  const [headingItemsState] = useState<TiptapBarItem[]>([
    {
      icon: `<svg class="w-5 h-5 sm:w-6 sm:h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0H24V24H0z"/><path d="M13 20h-2v-7H4v7H2V4h2v7h7V4h2v16zm8-12v12h-2v-9.796l-2 .536V8.67L19.5 8H21z"/></svg>`,
      title: NCMAZ_TRANSLATE["Heading 1"],
      action: () => editor.chain().focus().toggleHeading({ level: 1 }).run(),
      isActive: () => editor.isActive("heading", { level: 1 }),
    },
    {
      icon: `<svg class="w-5 h-5 sm:w-6 sm:h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0H24V24H0z"/><path d="M4 4v7h7V4h2v16h-2v-7H4v7H2V4h2zm14.5 4c2.071 0 3.75 1.679 3.75 3.75 0 .857-.288 1.648-.772 2.28l-.148.18L18.034 18H22v2h-7v-1.556l4.82-5.546c.268-.307.43-.709.43-1.148 0-.966-.784-1.75-1.75-1.75-.918 0-1.671.707-1.744 1.606l-.006.144h-2C14.75 9.679 16.429 8 18.5 8z"/></svg>`,
      title: NCMAZ_TRANSLATE["Heading 2"],
      action: () => editor.chain().focus().toggleHeading({ level: 2 }).run(),
      isActive: () => editor.isActive("heading", { level: 2 }),
    },
    {
      icon: `<svg class="w-5 h-5 sm:w-6 sm:h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0H24V24H0z"/><path d="M22 8l-.002 2-2.505 2.883c1.59.435 2.757 1.89 2.757 3.617 0 2.071-1.679 3.75-3.75 3.75-1.826 0-3.347-1.305-3.682-3.033l1.964-.382c.156.806.866 1.415 1.718 1.415.966 0 1.75-.784 1.75-1.75s-.784-1.75-1.75-1.75c-.286 0-.556.069-.794.19l-1.307-1.547L19.35 10H15V8h7zM4 4v7h7V4h2v16h-2v-7H4v7H2V4h2z"/></svg>`,
      title: NCMAZ_TRANSLATE["Heading 3"],
      action: () => editor.chain().focus().toggleHeading({ level: 3 }).run(),
      isActive: () => editor.isActive("heading", { level: 3 }),
    },
    {
      icon: `<svg class="w-5 h-5 sm:w-6 sm:h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0H24V24H0z"/><path d="M13 20h-2v-7H4v7H2V4h2v7h7V4h2v16zm9-12v8h1.5v2H22v2h-2v-2h-5.5v-1.34l5-8.66H22zm-2 3.133L17.19 16H20v-4.867z"/></svg>`,
      title: NCMAZ_TRANSLATE["Heading 4"],
      action: () => editor.chain().focus().toggleHeading({ level: 4 }).run(),
      isActive: () => editor.isActive("heading", { level: 4 }),
    },
    {
      icon: `<svg class="w-5 h-5 sm:w-6 sm:h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0H24V24H0z"/><path d="M22 8v2h-4.323l-.464 2.636c.33-.089.678-.136 1.037-.136 2.21 0 4 1.79 4 4s-1.79 4-4 4c-1.827 0-3.367-1.224-3.846-2.897l1.923-.551c.24.836 1.01 1.448 1.923 1.448 1.105 0 2-.895 2-2s-.895-2-2-2c-.63 0-1.193.292-1.56.748l-1.81-.904L16 8h6zM4 4v7h7V4h2v16h-2v-7H4v7H2V4h2z"/></svg>`,
      title: NCMAZ_TRANSLATE["Heading 5"],
  ...
  const [itemsState] = useState<(TiptapBarItem | TiptapBarItemDivider)[]>([
    ...
    },
    {
      ...
      title: NCMAZ_TRANSLATE["Blockquote"],
    ...
    },
    {
      ...
      title: NCMAZ_TRANSLATE["Bullet List"],
    ...
    },
    {
      ...
      title: NCMAZ_TRANSLATE["Ordered List"],
    ...
    },
    {
      ...
      title: NCMAZ_TRANSLATE["Code Block"],
  ...
  const [moreItemsState] = useState<(TiptapBarItem | TiptapBarItemDivider)[]>([
    {
      ...
      title: NCMAZ_TRANSLATE["Align left"],
    ...
    },
    {
      ...
      title: NCMAZ_TRANSLATE["Align center"],
    ...
    },
    {
      ...
      title: NCMAZ_TRANSLATE["Align right"],
    ...
    },
    {
      ...
      title: NCMAZ_TRANSLATE["Underline"],
...

    {
      ...
      title: NCMAZ_TRANSLATE["Highlight"],
...

    {
      ...
      title: NCMAZ_TRANSLATE["Horizontal Rule"],
...

    {
      ...
      title: NCMAZ_TRANSLATE["Hard Break"],
    ...
    },
    {
      ...
      title: NCMAZ_TRANSLATE["Clear Format"],
  ...
  const ITEM_STATE =
    windowSizeWidth <= 1024
      ? [...itemsState, ...headingItemsState, ...moreItemsState].filter(
          (i) => (i as TiptapBarItem).title !== NCMAZ_TRANSLATE["Heading"]
        )
      : itemsState;
  ...
  return (
    ...
    >
      <div className="w-full max-w-screen-md">
        <div className="flex items-center hiddenScrollbar px-2.5 lg:px-0 overflow-x-auto lg:overflow-x-visible -mx-2.5">
