...
export interface Card15PodcastSkeletonProps {
  className?: string;
}

const Card15PodcastSkeleton: FC<Card15PodcastSkeletonProps> = ({
  className = "h-full",
}) => {
  ...
  return (
    <div
      className={`nc-Card15PodcastSkeleton relative flex group items-center p-3 [ nc-box-has-hover ] [ nc-dark-box-bg-has-hover ] ${className}`}
...
export default Card15PodcastSkeleton;
